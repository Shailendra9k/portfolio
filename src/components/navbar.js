...
import LogoImg from "../assets/images/landing/name1.png";
      ...
      navbar = (
        <nav>
          <div ref={this.setWrapperRef} className="nav-wrapper container">
            <a className="nav-text-name center brand-logo" href="#landing_page">
              {
                <div>
                  {" "}
            ...
            >
              ...
              <li>
                <a className="nav-text" onClick={this.closeNav} href="#contact">
                  Contact
                </a>
              </li>
            </ul>
      ...
      navbar = (
        <nav>
          <div className="nav-wrapper container">
            <a className="nav-text-name" href="#landing_page">
              {<img src={LogoImg} width="100px" alt="" />}
            </a>
