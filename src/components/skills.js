    ...
    <section id="skills">
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col s12 l6 skills">
            <div className="col s6 push-l6 skillsText">
              ...
              <strong> OOP </strong> are essential developer skills
            </div>
            <img
        ...
        <div className="col s12 l6 skills">
          <div className="col s6 push-l6 skillsText">
            ...
            with <strong>Redux's</strong> state management is my favorite front
            end framework
          </div>
          <img
      ...
      <div className="row">
        <div className="col s12 l6 skills">
          ...
          />
          <div className="col s6 skillsText">
            Experience with <strong>CRUD</strong> operations using industry
            standard <strong>MySQL</strong> and the emerging{" "}
            <strong>Node.js</strong> with <strong>MongoDB</strong>
          </div>
        </div>
        ...
        <div className="row">
          ...
          <div className="col s12 l6 skills">
            <div className="col s6 push-l6 skillsText">
              ...
              <strong>Material Design</strong>. Image editing experience using
              Adobe <strong>Photoshop</strong> and <strong>Illustrator</strong>
            </div>
            <img
            ...
            />
            <img
              className="col s3 pull-l6 bootstrapLogo"
              src={bootstrapPs}
              alt="BootStrap Material Design PhotoShop Illustrator"
            />
          </div>
        </div>
      </div>
